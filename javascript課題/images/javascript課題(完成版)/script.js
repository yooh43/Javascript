...
resultMsg.onsubmit = function(e){
 ...
 //変数に納めて配列の準備
let img1 = '<img src="images/img1.jpg"></img>'
let img2 = '<img src="images/img2.jpg"></img>'
let img3 = '<img src="images/img3.jpg"></img>'
let img4 = '<img src="images/img4.jpg"></img>'
let img5 = '<img src="images/img5.jpg"></img>'

let imgBox = [img1,img2,img3,img4,img5]

//配列の繰り返し

const intavalId = setInterval(function(){
    imgBox.forEach(function(data,index){
        const idName = 'slide-img'+ (index+1);
        document.getElementById(idName).innerHTML = data;
    });


//データの入れ替え（先頭の削除・末尾に配置）・2秒ごとに入れ替え

const first = imgBox.shift();
imgBox.push(first);
},2000);
